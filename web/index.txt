...
.. NO DONATE on new sf platform
   Please also consider **donating** to Docutils: |donate|.
...
The latest **release package** is `docutils-0.14.tar.gz`__.  It was
released on 2017-08-03 and is mostly intended for distributors.  See
the `release notes`_ for a list of changes since the previous release.

__ https://sourceforge.net/projects/docutils/files/docutils/0.14/docutils-0.14.tar.gz/download
