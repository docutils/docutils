...
\newcommand{\styleinlinecustom}[1]{#1}
\newcommand{\styleinlinemysub}[1]{#1}
...
This text has a \styleinlinecustom{custom} inline role, a \ensuremath{^{custom
superscript}} role, and a \styleinlinemysub{\ensuremath{_{custom subscript}}} role.
\end{document}
