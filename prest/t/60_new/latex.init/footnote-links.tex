...
This paragraph has a footnote\footnotemark[1].
\footnotetext[1]{
http:://buffoon.org\renewcommand{\thefootnote}{\alph{footnote}}\footnote{http:://buffoon.org}\renewcommand{\thefootnote}{\arabic{footnote}}
}\end{document}
