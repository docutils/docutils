...
(\href{http://www.python.org}{http://www.python.org}), external hyperlinks (\href{http://www.python.org/}{Python}\raisebox{.5em}[0em]{\scriptsize\hyperlink{id23}{5}}), internal
...
hyperlink targets} (see \href{\#id20}{Targets} below for a reference back to here).
...
\href{\#id20}{Targets}, which is a subsection of \href{\#body-elements}{Body Elements}.

Explicit external targets are interpolated into references such as
``\href{http://www.python.org/}{Python}\raisebox{.5em}[0em]{\scriptsize\hyperlink{id23}{5}}''.

Targets may be indirect and anonymous.  Thus \href{\#id20}{this phrase} may also
refer to the \href{\#id20}{Targets} section.
...
\begin{figure}[b]\hypertarget{id23}$^{5}$
...
I recommend you try \href{http://www.python.org/}{Python, \emph{the} best language around}\raisebox{.5em}[0em]{\scriptsize\hyperlink{id23}{5}}.
...
text},~footnotes\raisebox{.5em}[0em]{\scriptsize\hyperlink{id6}{1}},~\hypertarget{id20}{targets},~and~\href{http://www.python.org/}{references}.
}\end{quote}
